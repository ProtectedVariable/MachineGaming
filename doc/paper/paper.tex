...
MongoDB est une technologie de base de données NoSQL orientée document permettant le stockage sans schéma prédéfini de volumes important d'informations\cite{wikimongo}.\\
...
Afin de permettre une implémentation personnalisée de l'interface de contrôle, le serveur met à disposition une API. Ainsi par le biais de quelques requêtes il est possible d'obtenir toutes les informations sur l'évolution et de contrôler la tâche à effectuer.\\
